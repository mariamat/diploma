...
export class ScheduleGridComponent implements OnInit {
  ...
  // constructor(private http: HttpClient) {
    // this.http.get('api/schedule').subscribe(response => {
    //   this.data = response;
    //   this.arrayData = this.data.items;
    // });
  ...
  ngOnInit() {
    // this.columns = [
    //   { key: 'title', title: 'Title', cellTemplate: this.title },
    //   { key: 'owner', title: 'Owner', cellTemplate: this.owner },
    //   { key: 'address', title: 'Address', cellTemplate: this.address },
    //   { key: 'email', title: 'Email', cellTemplate: this.email },
    //   { key: 'type', title: 'Type' },
    //   { key: 'stops', title: 'Stops' },
    //   { key: 'routine', title: 'Routine', cellTemplate: this.routine },
